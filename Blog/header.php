...
<body>
	...
	<div class="container">
		...
		<section class="container" >
			<div class="drop_head_menu">
			<ul class="sub_menu">
			<li class="menu__header"> Все потоки <i class="fa fa-chevron-down" aria-hidden="true"></i>
					<ul class="sub_menu_drop" id="menu_hiden">
							<li><a href="#">Разработка</a></li>
							<li><a href="#">Администрирование</a></li>
							<li><a href="#">Дизайн</a></li>
							<li><a href="#">Управление</a></li>
							<li><a href="#">Маркетинг</a></li>
							<li><a href="#">Гиктаймс</a></li>
			...
			<ul class="publications_choice" >
			<li ></li> <a class="active" href="https://habr.com/ru/top/">лучшие</a>	</li>
			<li> <a class="all_rows" href="">все подряд</a> </li>
		</ul>
		<hr>
		<ul class="toggle_menu">
			<li class="menu_item "><a class="activ" href="https://habr.com/ru/top/">Сутки</a></li>
			<li class="menu_item"><a href="https://habr.com/ru/top/weekly/">Неделя</a></li>
			<li class="menu_item"><a href="https://habr.com/ru/top/monthly/">Месяц</a></li>
			<li class="menu_item"><a href="https://habr.com/ru/top/yearly/">Год</a></li>
		</ul>
		</section>
		</header>